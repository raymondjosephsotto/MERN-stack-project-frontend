...
import { useImg } from '../../shared/hooks/img-hook';
...
const Auth = () => {
	...
	const { showImage, showLink, pgFirstName, pgLastName } = useImg();
		...
		<React.Fragment>
			...
			<div
				...
				<div className='grid-container'>
					...
					<AuthHeader className='authentication-header' />
				</div>
				<footer className='footer-credits'>
					<a href={showLink}>
						{pgFirstName} {pgLastName} / Unsplash
					</a>
				</footer>
			</div>
		</React.Fragment>
